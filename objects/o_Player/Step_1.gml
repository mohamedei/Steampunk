...
if(mouse_check_button(mb_left) && firing_delay<0)	//if LMB is clicked  and firing delay is finished
{
	...
	if((shotstate == shots.normal) || (shotstate == shots.ice || shotstate == shots.fire) && global.xp>0)
	{
	with(instance_create_layer(x+64*dir,y,"Bullet",o_Bullet))	//create a bullet
	{
	switch(other.shotstate)
	{
	case shots.normal:{ image_index = 0; break;}
	case shots.ice:{ image_index = 1;global.xp-=10; break;}
	case shots.fire: {image_index = 2; global.xp-=10; break;}
	}
